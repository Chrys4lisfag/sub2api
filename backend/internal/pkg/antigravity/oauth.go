...
// env var or the runtime resolver. Default tracks the latest official Google
// Antigravity release (1.23.2 from 2026-04-16). Google's antigravity backend
// rejects older versions with "This version of Antigravity is no longer
// supported" once the cutoff drifts past them; bump alongside upstream.
