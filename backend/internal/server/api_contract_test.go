		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"default_platform_quotas": {"anthropic":{"daily":null,"weekly":null,"monthly":null},"antigravity":{"daily":null,"weekly":null,"monthly":null},"antigravity_native":{"daily":null,"weekly":null,"monthly":null},"gemini":{"daily":null,"weekly":null,"monthly":null},"grok":{"daily":null,"weekly":null,"monthly":null},"openai":{"daily":null,"weekly":null,"monthly":null}},
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	adminAccountHandler := adminhandler.NewAccountHandler(adminService, nil, nil, nil, nil,
