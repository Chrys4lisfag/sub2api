...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	// 146 originally shipped with self-managed BEGIN/COMMIT; stripped so the
	// runner's own transaction wraps it (fresh-DB "transaction status idle" fix).
	// Prod already applied the old (BEGIN/COMMIT) body -> accept its stored checksum.
	"146_extend_user_platform_quotas_check_for_native.sql": newMigrationChecksumCompatibilityRule("164bc372dd47665af88f561c035a6b03f09dda77af4708930f80896363aee6dd", "2b051faa5f4c392962fe536b0b85f585a2cd5ace4120d68d984d69b3cc5bed48"),
