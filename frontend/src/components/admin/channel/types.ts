...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'antigravity':
    case 'antigravity_native': return 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'antigravity':
    case 'antigravity_native': return 'text-purple-700 dark:text-purple-400'
