...
watch(authCodeInput, (newVal) => {
  if (props.platform !== 'openai' && props.platform !== 'gemini' && props.platform !== 'antigravity' && props.platform !== 'antigravity_native' && props.platform !== 'grok') return
  ...
  if (trimmed.includes('code=')) {
    try {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'antigravity' || props.platform === 'antigravity_native' || props.platform === 'grok') && stateParam) {
      ...
      if ((props.platform === 'openai' || props.platform === 'gemini' || props.platform === 'antigravity' || props.platform === 'antigravity_native' || props.platform === 'grok') && stateMatch && stateMatch[1]) {
