...
// ── 平台限额类型 ──────────────────────────────────────────────────
export type PlatformType = "anthropic" | "openai" | "gemini" | "antigravity" | "antigravity_native" | "grok"
...
const PLATFORMS: PlatformType[] = ["anthropic", "openai", "gemini", "antigravity", "antigravity_native", "grok"]
...
export interface SystemSettings {
  ...
  herosms_api_key_configured: boolean; // HeroSMS key is write-only
