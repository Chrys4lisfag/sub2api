...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'antigravity_native' | 'grok'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'antigravity_native' | 'grok'
