...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'antigravity_native'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'antigravity_native'
